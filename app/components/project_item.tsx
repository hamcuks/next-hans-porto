...
const ProjectItem = ( params: { data: Project } ) => {
  return (
    <div className="p-4 rounded-2xl flex flex-col border-2">
        <img className="w-full h-48 mb-4 border-2 border-slate-200 md:mb-0 rounded-md" src={ params.data.thumbnail } alt="" />
